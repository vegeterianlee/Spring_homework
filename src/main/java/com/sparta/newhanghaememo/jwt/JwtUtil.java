...
import com.sparta.newhanghaememo.security.UserDetailsServiceImpl;
...
@Slf4j
@Component //굳이 써야하는 가? Entity,service, repository모두 component이니깐 그 중하나로
//bean 대상에 쓰는 것인데 @RequiredArgsConstructor 대체 가능했음
